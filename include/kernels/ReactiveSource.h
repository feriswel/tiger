...
/****************************************************************/
#ifndef REACTIVESOURCE_H
#define REACTIVESOURCE_H
...
template <>
InputParameters validParams<ReactiveSource>();
 ...
 */
class ReactiveSource : public DerivativeMaterialInterface<JvarMapKernelInterface<Kernel>>
{
public:
  ReactiveSource(const InputParameters & parameters);
